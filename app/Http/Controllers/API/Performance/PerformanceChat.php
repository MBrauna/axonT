<?php
    ...
    class PerformanceChat extends Controller
    {
        public function getChart(Request $request) {
            try {
                $idEmpresa  =   $request->input('idCompany',0);

                return response()->json([
                    $this->graph1($request, $idEmpresa),
                    $this->graph2($request, $idEmpresa),
                    $this->graph3($request, $idEmpresa),
                    $this->graph4($request, $idEmpresa),
                    $this->graph5($request, $idEmpresa),
                ],200);
            }
